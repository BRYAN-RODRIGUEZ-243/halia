...
function toggleDropdown(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 bg-linear-to-br from-brand-500 to-brand-700 flex items-center justify-center">
          {!isLoading && user?.name ? (
        ...
        <span className="block mr-1 font-medium text-theme-sm">
          {isLoading ? "Cargando..." : user?.name?.split(" ")[0] || "Usuario"}
        </span>
      ...
      >
        <div>
          ...
          {user?.role && (
            <span className="mt-1 inline-flex items-center rounded-full bg-brand-50 px-2 py-0.5 text-xs font-medium text-brand-700 dark:bg-brand-900/30 dark:text-brand-400">
